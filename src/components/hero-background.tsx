...
export function HeroBackground() {
  ...
  return (
    <div className="absolute inset-0 isolate size-full min-h-screen overflow-hidden bg-gray-900/80 backdrop-blur-lg">
      {/* Grid pattern */}
      <svg
        aria-hidden="true"
      ...
      {/* Gradient blob */}
      <div aria-hidden="true" className="absolute top-1/2 left-1/2 -z-10 -translate-x-1/2 -translate-y-1/2 blur-3xl">
        <div
          style={{
            clipPath:
